...
import { getAvailableMeetingSchedule } from '#root/features/contact-us/api/getAvailableMeetingSchedules.api'
import { TimePickerHeader } from '#root/features/contact-us/components/styles'
import { theme } from '#root/themes/theme'
import { CurrentMeetingDto } from '#root/types/root-types'
  ...
  return (
    <Wrapper>
      <Box textAlign="center">
        <Typography variant="h1" fontSize="30px" textAlign="center" color={theme.palette.info.main}>
          Schedule a call
        </Typography>
        <Typography
          sx={{
              ...
              <Box sx={{ width: { md: '100%' } }}>
                <TimePickerHeader>
                  <Box textAlign="left" display="flex">
                    <Typography variant="h1" color={theme.palette.info.main} paddingRight="6px" fontSize="16px">
                      {weekDay}
                    </Typography>
                    <Typography variant="h1" color={theme.palette.info.main} fontSize="16px">
                      {describedDate}
                    </Typography>
                  </Box>
                </TimePickerHeader>

                <Box sx={{ display: 'inline-flex', justifyContent: 'space-between', flexWrap: 'wrap' }}>
