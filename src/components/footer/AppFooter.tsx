import { CopyRightSection } from '#root/components/footer/CopyRightSection'
import { FooterInfoSection } from '#root/components/footer/FooterInfoSection'
...
export const AppFooter = () => {
  ...
  return (
    <Wrapper style={isMobile ? { paddingBottom: 64 } : { paddingBottom: 0 }}>
      <Typography variant="h1" fontSize="36px" textAlign="center">
